...
@section('page-header')
    <small>{{ trans('app.add_exit_process') }}</small>
@stop
...
@section('content')
    ...
    <div class="container" style="padding: 20px;background-color: #fff">
        <form method="POST" action="{{route(ADMIN . '.exitProcess' , $item->id)}}">
            @csrf
            <div class="row">
                <div  class="col-6">
                    <label>{{__('app.process_type')}}</label>
                    <select type="text" disabled  class="form-control" name="process_type" >
{{--                        <option value="">----</option>--}}
                ...
                <div  class="col-6">
                    ...
                    <select type="text" disabled class="form-control" name="client_id"   value="{{ $item['client_id'] }}">
                        <option value="">----</option>
                ...
                <div  class="col-6">
                    ...
                    <select type="text" disabled class="form-control floorSelect" name="floor_id"  value="{{ $item['floor_id']}}">
                        <option value="">----</option>
                ...
                <div  class="col-6">
                        ...
                        <select type="text" disabled="true" class="form-control warehouseSelect " name="warehouse_id"  value="{{ $item['warehouse_id']}}">
                ...
                <div  class="col-6">
                    ...
                    <select type="text" disabled class="form-control productSelect" name="product_id"  value="{{$item['product_id']}}">
                        <option value="">----</option>
                ...
                <div  class="col-6">
                    ...
                    <select type="text"  disabled class="form-control typeSelect" name="product_type_id" value="{{ $item['product_type_id']}}">
                        <option value="">----</option>
                ...
                <div  class="col-6">
                    ...
                    <select type="text" disabled class="form-control" disabled name="sacks_type_id" value="{{ $item['sacks_type_id']}}">
                        <option value="">----</option>
                ...
                <div  class="col-6">
                    ...
                    <input type="text" disabled class="form-control" name="sacks_color" value="{{ $item['sacks_color'] }}">
                </div>
                <div  class="col-6">
                    <label>{{__('app.seasonName')}}</label>
                    <select type="text" disabled class="form-control" name="season_id" value="{{ $item['season_id'] }}">
...
{{--                               <option value="{{$seasons->id}}" >{{ $seasons->seasonName }}</option>--}}
                ...
                <div  class="col-6">
                    ...
                    <input type="date"  disabled class="form-control" name="date" value="{{ $item['date'] }}">
                </div>
                <div  class="col-12">
                    <label>{{__('app.notes')}}</label>
                    <textarea  disabled class="form-control" name="notes" >{{ $item['notes'] }}</textarea>
                </div>
            </div>
